...
export default function ProjectEditorScreen() {
  ...
  const {
    ...
    setActiveScreen,
    addScreen,
    // addComponent, // Removed as components are now generated by AI or added via palette
  } = useEditorStore();
  ...
  // Temporary function to add a component for testing - REMOVED
  ...
  return (
    <View style={styles.container}>
      ...
      {/* Temporary button to add components for testing - REMOVED */}
      {/* <Button
        mode="contained"
