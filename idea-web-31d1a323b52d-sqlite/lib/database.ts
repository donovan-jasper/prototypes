...
export const createDatabase = async (name: string, fields: DatabaseField[]): Promise<void> => {
...
export const insertRow = async (table: string, data: Record<string, any>): Promise<number> => {
  return new Promise((resolve, reject) => {
...
export const queryDatabase = async (table: string, sql: string): Promise<any[]> => {
  return new Promise((resolve, reject) => {
    db.transaction(
      tx => {
        tx.executeSql(
...
export const getDatabaseSchema = async (): Promise<Record<string, DatabaseField[]>> => {
  return new Promise((resolve, reject) => {
    db.transaction(
      tx => {
        tx.executeSql(
